                ...
                <article className="space-y-12 pb-20">
                    <section className="space-y-4">
                        <p className="leading-relaxed text-lg">
                            At Vacation Scheduler, we believe your data should be handled with transparency and respect. This policy explains how we collect and process your information when you use our service.
                        </p>
                    </section>

                    <section className="space-y-6">
                        <h2 className="text-xl font-bold text-gray-100 flex items-center gap-2 border-b border-dark-700 pb-2">
                            <Eye className="text-blue-400" size={20} /> What Data We Collect
                        </h2>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="bg-dark-900 border border-dark-700 rounded-xl p-5">
                                <h3 className="font-bold text-gray-200 mb-2">Participant Information</h3>
                                <p className="text-sm leading-relaxed text-gray-400">
                                    We store names and (optionally) email addresses provided by you. These are used to identify you within your specific vacation group.
                                </p>
                            </div>
                            <div className="bg-dark-900 border border-dark-700 rounded-xl p-5">
                    ...
                    <section className="space-y-6">
                        ...
                        <div className="space-y-4 text-sm leading-relaxed">
                            ...
                            <p>
                                ...
                                <span className="text-blue-400"> This storage is functional and helps provide the service you requested.</span>
                            </p>
                            <p>
                    ...
                    <section className="space-y-4 bg-dark-950 p-6 rounded-xl border border-dark-800">
                        ...
                        <p className="text-sm">
                            Questions about your privacy? Contact us at: <a href="mailto:vacationscheduler.info@gmail.com" className="text-blue-400 hover:underline">vacationscheduler.info@gmail.com</a>
                        </p>
                    </section>
                </article>
            </div>
